...
export class AddColumnSoftDeleteForPetModel1716948075191 implements MigrationInterface {
    name = 'AddColumnSoftDeleteForPetModel1716948075191'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "pet" ADD "deletedAt" TIMESTAMP`);
